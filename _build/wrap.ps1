...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,500;0,600;0,700;1,600&family=Karla:wght@400;700&family=Caveat:wght@600;700&display=swap&subset=latin-ext" rel="stylesheet">
